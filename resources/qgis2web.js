...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-347033.737362, 311996.231589, 869892.940265, 1774353.499662], maxZoom: 28, minZoom: 1
    })
});


    var searchLayer = new SearchLayer({
      layer: lyr_Dedroitcommun_0,
      colName: 'NAME',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-347033.737362, 311996.231589, 869892.940265, 1774353.499662], map.getSize());
